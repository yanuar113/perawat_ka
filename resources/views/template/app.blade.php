...
<head>
    ...
    <link href="{{assets('tempaltes/source/assets/plugins/perfectscroll/perfect-scrollbar.css')}}" rel="stylesheet">
    <link href="{{assets('tempaltes/source/assets/plugins/pace/pace.css')}}" rel="stylesheet">

    
    <!-- Theme Styles -->
    <link href="{{assets('tempaltes/source/assets/css/main.min.css')}}" rel="stylesheet">
    <link href="{{assets('tempaltes/source/assets/css/custom.css')}}" rel="stylesheet">

    <link rel="icon" type="image/png" sizes="32x32" href="{{assets('tempaltes/source/assets/images/neptune.png')}}" />
    <link rel="icon" type="image/png" sizes="16x16" href="{{assets('tempaltes/source/assets/images/neptune.png')}}" />
...
<body>
                                        ...
                                        <div class="widget-connection-request-container d-flex">
                                            <div class="widget-connection-request-avatar">
                                                <div class="avatar avatar-xl m-r-xs">
                                                    <img src="../../assets/images/avatars/avatar8.jpeg" alt="">
                                                </div>
                                            </div>
    ...
    <!-- Javascripts -->
    <script src="{{assets('tempaltes/source/assets/plugins/jquery/jquery-3.5.1.min.js')}}"></script>
    <script src="{{assets('tempaltes/source/assets/plugins/bootstrap/js/bootstrap.min.js')}}"></script>
    <script src="{{assets('tempaltes/source/assets/plugins/perfectscroll/perfect-scrollbar.min.js')}}"></script>
    <script src="{{assets('tempaltes/source/assets/plugins/pace/pace.min.js')}}"></script>
    <script src="{{assets('tempaltes/source/assets/plugins/apexcharts/apexcharts.min.js')}}"></script>
    <script src="{{assets('tempaltes/source/assets/js/main.min.js')}}"></script>
    <script src="{{assets('tempaltes/source/assets/js/custom.js')}}"></script>
    <script src="{{assets('tempaltes/source/assets/js/pages/dashboard.js')}}"></script>
</body>
</html>